...
namespace DG.EmbratelIntranet.SuporteServicos.Structure.Features.Install
{
    /// <summary>
    ...
    [Guid("e8ecd33b-e4fe-4a66-9aee-ccd8f4fd37ec")]
    public class InstallEventReceiver : SPFeatureReceiver
    {
        // Uncomment the method below to handle the event raised after a feature has been activated.

        string name = "Suporte e Serviços";
        string path = "/suporteservicos";
