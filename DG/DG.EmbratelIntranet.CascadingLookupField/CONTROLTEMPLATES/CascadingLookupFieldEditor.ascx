<%@ Control Language="C#" AutoEventWireup="false" CompilationMode="Always" Inherits="DG.EmbratelIntranet.CascadingLookupField.CascadingLookupFieldEditor, $SharePoint.Project.AssemblyFullName$" %>
<%@ Register TagPrefix="wssuc" TagName="InputFormControl" src="~/_controltemplates/InputFormControl.ascx" %>
<%@ Register TagPrefix="wssuc" TagName="InputFormSection" src="~/_controltemplates/InputFormSection.ascx" %>
<%@ Register Tagprefix="SharePoint" Namespace="Microsoft.SharePoint.WebControls" Assembly="Microsoft.SharePoint, Version=12.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>
<%@ Register Tagprefix="Utilities" Namespace="Microsoft.SharePoint.Utilities" Assembly="Microsoft.SharePoint, Version=12.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>
<%@ Import Namespace="Microsoft.SharePoint" %>
<wssuc:InputFormSection runat="server" id="FilterLookupFieldSection" Title="Configura&ccedil;&otilde;es da coluna">
  <template_inputformcontrols>
    <wssuc:InputFormControl runat="server" LabelText="Especifique informa&ccedil;&otilde;es detalhadas sobre a coluna filtrada">
      <Template_Control>
            ...
            <table style="width: 100%; border-width: 0px; border-collapse: collapse;" cellpadding="0" cellspacing="0">
              <tr>
                <td class="ms-authoringcontrols" style="width: 100%; text-align: left; white-space: nowrap; padding-top: 10px;">
                  <span>Obter informa&ccedil;&atilde;o do site:</span>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <span style="padding-left: 0px;">
                  <asp:RadioButtonList CssClass="ms-authoringcontrols" RepeatLayout="Flow" RepeatDirection="Horizontal" runat="server" ID="rdFilterOption" OnSelectedIndexChanged="SelectedFilterOptionChanged" AutoPostBack="true">
                    <asp:ListItem Selected="True" Text="Aplicar filtro por Query" Value="Query" />
                    <asp:ListItem Text="Aplicar filtro por ListView" Value="ListView" />
                  </asp:RadioButtonList>
                 </span>
                </td>
              </tr>
